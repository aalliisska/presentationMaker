...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "fs", "../src"], factory);
    }
    ...
    describe('HTML Parser', function () {
        describe('Matcher', function () {
            it('should match corrent elements', function () {
                var matcher = new src_1.Matcher('#id .a a.b *.a.b .a.b * a');
                var MatchesNothingButStarEl = new src_1.HTMLElement('_');
                var withIdEl = new src_1.HTMLElement('p', "id='id'");
                var withClassNameEl = new src_1.HTMLElement('a', "class='a b'");
        ...
        describe('parse()', function () {
            it('should parse "<p id=\\"id\\"><a class=\'cls\'>Hello</a><ul><li><li></ul><span></span></p>" and return root element', function () {
                var root = (0, src_1.parse)('<p id="id"><a class=\'cls\'>Hello</a><ul><li><li></ul><span></span></p>');
                var p = new src_1.HTMLElement('p', 'id="id"');
                p.appendChild(new src_1.HTMLElement('a', 'class=\'cls\''))
                    .appendChild(new src_1.TextNode('Hello'));
                var ul = p.appendChild(new src_1.HTMLElement('ul'));
            ...
            it('should parse "<DIV><a><img/></A><p></P></div>" and return root element', function () {
                var root = (0, src_1.parse)('<DIV><a><img/></A><p></P></div>', {
                    lowerCaseTagName: true
                });
                var div = new src_1.HTMLElement('div');
                var a = div.appendChild(new src_1.HTMLElement('a'));
            ...
            it('should parse text nodes and return a root element containing the text node as only child', function () {
                var root = (0, src_1.parse)('text node');
                var textNode = new src_1.TextNode('text node');
            ...
            it('should parse "<div><a><!-- my comment --></a></div>" and return root element without comments', function () {
                var root = (0, src_1.parse)('<div><a><!-- my comment --></a></div>');
                var div = new src_1.HTMLElement('div');
            ...
            it('should parse "<div><a><!-- my comment --></a></div>" and return root element with comments', function () {
                var root = (0, src_1.parse)('<div><a><!-- my comment --></a></div>', { comment: true });
                var div = new src_1.HTMLElement('div');
                var a = div.appendChild(new src_1.HTMLElement('a'));
            ...
            it('should not parse HTML inside comments', function () {
                var root = (0, src_1.parse)('<div><!--<a></a>--></div>', { comment: true });
                var div = new src_1.HTMLElement('div');
            ...
            it('should set the parent when adding nodes', function () {
                var root = (0, src_1.parse)('<div>a</div><div>b</div>', { comment: true });
                root.firstChild.parentNode.should.eql(root);
            });
            it('should parse picture element', function () {
                var root = (0, src_1.parse)('<picture><source srcset="/images/example-1.jpg 1200w, /images/example-2.jpg 1600w" sizes="100vw"><img src="/images/example.jpg" alt="Example"/></picture>');
                var picture = new src_1.HTMLElement('picture');
            ...
            it('should not extract text in script and style by default', function () {
                var root = (0, src_1.parse)('<script>1</script><style>2</style>');
            ...
            it('should be able to parse namespaces', function () {
                var namespacedXML = '<ns:identifier>content</ns:identifier>';
            ...
            it('should parse "<div attr=">"></div>"', function () {
                var root = (0, src_1.parse)("<div attr='>'></div>");
        ...
        describe('parseWithValidation', function () {
            ...
            it('should return Object with valid: true.  does not count <p><p></p> as error. instead fixes it to <p></p><p></p>', function () {
                var result = (0, src_1.parse)('<p><p></p>');
            ...
            it('should return Object with valid: false.  does not count <p><h3></p> as error', function () {
                var result = (0, src_1.parse)('<p><h3></p>');
            ...
            it('hillcrestpartyrentals.html  should return Object with valid: false.  not closing <p> tag on line 476', function () {
                var result = (0, src_1.parse)(fs_1.default.readFileSync(__dirname + '/html/hillcrestpartyrentals.html').toString());
                result.valid.should.eql(false);
            });
            it('google.html  should return Object with valid: true', function () {
                var result = (0, src_1.parse)(fs_1.default.readFileSync(__dirname + '/html/google.html').toString());
                result.valid.should.eql(true);
            });
            it('gmail.html  should return Object with valid: true', function () {
                var result = (0, src_1.parse)(fs_1.default.readFileSync(__dirname + '/html/gmail.html').toString());
                result.valid.should.eql(true);
            });
            it('ffmpeg.html  should return Object with valid: false (extra opening <div>', function () {
                var result = (0, src_1.parse)(fs_1.default.readFileSync(__dirname + '/html/ffmpeg.html').toString());
                result.valid.should.eql(false);
            });
            // fix issue speed test
            it('should fix "<div><h3><h3><div>" to "<div><h3></h3></div>"', function () {
                var result = (0, src_1.parse)('<div data-id=1><h3 data-id=2><h3><div>');
                result.valid.should.eql(false);
            ...
            it('should fix "<div><h3><h3><span><span><div>" to "<div><h3></h3><span></span></div>"', function () {
                var result = (0, src_1.parse)('<div><h3><h3><span><span><div>');
                result.valid.should.eql(false);
                result.toString().should.eql('<div><h3></h3><span></span></div>');
            });
            it('gmail.html  should return Object with valid: true', function () {
                var result = (0, src_1.parse)(fs_1.default.readFileSync(__dirname + '/html/gmail.html').toString().replace(/<\//gi, '<'));
                result.valid.should.eql(false);
            });
            it('gmail.html  should return Object with valid: true', function () {
                var result = (0, src_1.parse)(fs_1.default.readFileSync(__dirname + '/html/nice.html').toString().replace(/<\//gi, '<'));
                result.valid.should.eql(false);
            });
        });
        describe('TextNode', function () {
            describe('#isWhitespace', function () {
                var node = new src_1.TextNode('');
        ...
        describe('HTMLElement', function () {
            ...
            describe('#remove()', function () {
                it('should remove the current node', function () {
                    var root = (0, src_1.parse)('<div><p></p></div>');
                    var child = root.firstChild;
            ...
            describe('#removeWhitespace()', function () {
                it('should remove whitespaces while preserving nodes with content', function () {
                    var root = (0, src_1.parse)('<p> \r \n  \t <h5> 123 </h5></p>');
                    var p = new src_1.HTMLElement('p');
            ...
            describe('#rawAttributes', function () {
                it('should return escaped attributes of the element', function () {
                    var root = (0, src_1.parse)('<p a=12 data-id="!$$&amp;" yAz=\'1\'></p>');
                    var child = root.firstChild;
            ...
            describe('#attributes', function () {
                it('should return attributes of the element', function () {
                    var root = (0, src_1.parse)('<p a=12 data-id="!$$&amp;" yAz=\'1\' class="" disabled></p>');
                    var child = root.firstChild;
            ...
            describe('#setAttribute', function () {
                it('should edit the attributes of the element', function () {
                    var root = (0, src_1.parse)('<p a=12></p>');
                    var child = root.firstChild;
                ...
                it('should remove an attribute from the element', function () {
                    var root = (0, src_1.parse)('<p a=12 b=13 c=14 data-id="!$$&amp;"></p>');
                    var child = root.firstChild;
            ...
            describe('#querySelector()', function () {
                it('should return correct elements in DOM tree', function () {
                    var root = (0, src_1.parse)('<a id="id" data-id="myid"><div><span class="a b"></span><span></span><span></span></div></a>');
                    var child = root.firstChild;
            ...
            describe('#querySelectorAll()', function () {
                it('should return correct elements in DOM tree', function () {
                    var root = (0, src_1.parse)('<a id="id"><div><span id="3" class="a b"></span><span></span><span></span></div></a>');
                    var child = root.firstChild;
                    var grandChild = child.firstChild;
        ...
        describe('stringify', function () {
            it('#toString()', function () {
                var html = '<p id="id" data-feidao-actions="ssss"><a class=\'cls\'>Hello</a><ul><li>aaaaa</li></ul><span>bbb</span></p>';
                var root = (0, src_1.parse)(html);
                root.toString().should.eql(html);
            });
            it('#toString() should not return comments by default', function () {
                var html = '<p><!-- my comment --></p>';
                var result = '<p></p>';
                var root = (0, src_1.parse)(html);
            ...
            it('#toString() should return comments when specified', function () {
                var html = '<!----><p><!-- my comment --></p>';
                var root = (0, src_1.parse)(html, { comment: true });
                root.toString().should.eql(html);
            });
        ...
        describe('Custom Element multiple dash', function () {
            it('parse "<my-new-widget></my-new-widget>" tagName should be "my-new-widget"', function () {
                var root = (0, src_1.parse)('<my-new-widget></my-new-widget>');
                var child = root.firstChild;
        ...
        describe('Font family', function () {
            it('parse font-family style attribute', function () {
                var root = (0, src_1.parse)("<div style='font-family: \"Nunito\", \"Arial\", sans-serif'></div>");
                var child = root.firstChild;
